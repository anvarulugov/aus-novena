...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/plugins/icofont/icofont.min.css">
...
<script src="<?php echo get_template_directory_uri(); ?>/plugins/shuffle/shuffle.min.js"></script>
